...
function addResults {
  ...
  local targetFolder=$(resolveResultsPath ${results})
...
export GITHUB_PERSIST_COMMIT_URL="${GITHUB_TEST_RESULTS_BROWSE_URL}/$(resolveResultsPath ${BUILD_HASH})"
export GITHUB_PERSIST_BRANCH_URL="${GITHUB_TEST_RESULTS_BROWSE_URL}/$(resolveResultsPath current)"
